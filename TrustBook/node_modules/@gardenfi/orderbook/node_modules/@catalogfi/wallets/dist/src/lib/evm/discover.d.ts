...
export declare const getKeysFromAddress: (index: number, account: number, rootNode: HDNodeWallet) => {
    address: string;
    path: string;
    publicKey: string;
    privateKey: string;
};
export declare const generateRootNode: (mnemonic: string) => HDNodeWallet;
/**
